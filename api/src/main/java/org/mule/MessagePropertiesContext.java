...
public class MessagePropertiesContext implements Serializable
{
    ...
    private static Logger logger = LoggerFactory.getLogger(MessagePropertiesContext.class);
    ...
    public void setProperty(String key, Object value, PropertyScope scope)
    {
        ...
        {
            logger.warn(CoreMessages.sessionPropertyNotSerializableWarning(key).getMessage());
        }
